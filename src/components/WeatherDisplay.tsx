...
export function WeatherDisplay({ weather }: WeatherDisplayProps) {
  ...
  return (
    <div className="flex flex-col items-center space-y-6 w-full">
      ...
      {/* NEW: Main weather card - now clickable/tappable */}
      <Link
        href={`/weather/${weather.city.toLowerCase()}`}
        className="w-full block transition-transform hover:scale-[1.02] active:scale-[0.98] duration-200"
      >
        <div className="w-full bg-white dark:bg-gray-800 rounded-3xl p-8 shadow-sm border border-gray-100 dark:border-gray-700 cursor-pointer hover:shadow-md transition-shadow duration-200">
          ...
          {/* NEW: Visual hint that card is clickable */}
          <div className="mt-6 pt-4 border-t border-gray-100 dark:border-gray-700 text-center">
            <p className="text-sm text-gray-500 dark:text-gray-400 font-light flex items-center justify-center gap-2">
